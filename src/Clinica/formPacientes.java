...
public class formPacientes extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					formPacientes frame = new formPacientes();
	...
	public formPacientes() {
		...
		mntmNewMenuItem.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent arg0) {
				...
				FormBajaPaciente Fbaja = new FormBajaPaciente();
		...
		btnIngreso.setBounds(346, 217, 89, 23);
			...
			public void actionPerformed(ActionEvent arg0) {
				if(ingreso) {											// Verificar si es para ingresar
					...
					if (paciente.darAltaPaciente()) {
						...
						JOptionPane.showMessageDialog(btnIngreso, "El cliente ha sido modificado correctamente", "Modificar Pacientes", JOptionPane.INFORMATION_MESSAGE);
						formParaModificar();
					}
			}
		});
