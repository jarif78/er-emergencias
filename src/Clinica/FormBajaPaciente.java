...
public class FormBajaPaciente extends JDialog {
	...
	public static void main(String[] args) {
		try {
			FormBajaPaciente dialog = new FormBajaPaciente();
	...
	public FormBajaPaciente() {
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				//int p = JOptionPane.showMessageDialog(btnEliminar, "Desea borrar al paciente: "+paciente.getNombrePac(), "Borrar pacientes", JOptionPane.YES_NO_OPTION)
				
				//JOptionPane.showMessageDialog(btnEliminar, "Desea borrar al paciente: "+paciente.getNombrePac(), "Borrar pacientes", JOptionPane.YES_NO_OPTION));
